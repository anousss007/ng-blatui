...
- **Behavior layer**: build accessible component behavior on **Angular Aria** (`@angular/aria`) + **Angular CDK** (`@angular/cdk`) — do not hand-roll ARIA/keyboard/focus.
- **Styling**: Tailwind CSS v4 + the **BlatUI oklch design tokens** (CSS variables) in `projects/ng-blatui/foundations/blatui.css`. Every token is a CSS variable; never hard-code colors/radii.
- **Selectors**: library prefix `bui` (e.g. `<bui-button>`); demo app prefix `app`.
